...
class ExperienceSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Experience::create([
            ...
            'image' => "/images/activities/canyoning/cales_01.jpg",
            'type' => "canyoning",
            'description' => ['en' => "This canyoning is intended for those who wish to have the first contact with the activity. It is a easy and accessible route for all ages (over 10 years old).", 'pt' => "Pacote Família"],
            'level' => 1,
            'pickup' => ['en' => "Canyoning location", 'pt' => "Local do canyoning"],
            'pickup_address' => "https://maps.app.goo.gl/QGif4UZZpUGJGnph7",
            'price' => 60,
            'private_price' => 150,
            'activity_id' => 1,
        ]);
        ...
        Experience::create([
            ...
            'image' => "/images/activities/canyoning/ribeiro_frio_01.jpg",
            'type' => "canyoning",
        ...
        Experience::create([
            ...
            'image' => "/images/activities/canyoning/funda_011.jpg",
            'type' => "canyoning",
        ...
        Experience::create([
            ...
            'image' => "/images/activities/hiking/25fontes_01.jpg",
            'type' => "hiking",
        ...
        Experience::create([
            ...
            'image' => "/images/activities/hiking/picos_01.jpg",
            'type' => "hiking",
        ...
        Experience::create([
            ...
            'image' => "/images/activities/hiking/saolourenco_01.jpg",
            'type' => "hiking",
        ...
        Experience::create([
            ...
            'image' => "/images/activities/jeep/12.jpg",
            'type' => "jeep",
        ...
        Experience::create([
            ...
            'image' => "/images/activities/jeep/13.jpg",
            'type' => "jeep",
        ...
        Experience::create([
            ...
            'image' => "/images/activities/jeep/11.jpg",
            'type' => "jeep",
