        ...
        <div>
            ...
            <Container>
                <h2 className="subtitle">
                    {text.levels.items[index].subtitle}
                </h2>
                <ImageContainer>
                    <img
                        className="m1"
                        src={
                            ...
                            text.levels.items[index].images[0] +
                            ".jpg"
                        }
                    />
                    <div className="vertical-container">
                        <img
                            ...
                            src={
                                "/image/activities/levels/" +
                                text.levels.items[index].images[1] +
                                ".jpg"
                            }
                        />
                        <img
                            ...
                            src={
                                "/image/activities/levels/" +
                                text.levels.items[index].images[2] +
                                ".jpg"
                            }
                        />
                    </div>
                ...
                <Content>
                    <InfoContainer>
                        ...
                        <DetailsContainer type="flex" justify="space-between">
                            {text.levels.details.items[index].map(
                                (detail, detailIndex) => (
                                    <Col xs={12} md={12}>
                                        <h4>
                                            {
                                                text.levels.details.titles[
                                                    detailIndex
                                                ]
                                            }
                                        </h4>
