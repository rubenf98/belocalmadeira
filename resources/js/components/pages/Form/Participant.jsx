            ...
            <PersonForm gutter={32} key={index}>
                <Col xs={24} md={8}>
                    <Form.Item name="name" rules={rules.name}>
                        <CustomInput
                            placeholder={text.form.person.name.placeholder}
                            style={{ width: "100%" }}
                        />
                    </Form.Item>
                </Col>
                <Col xs={24} md={8}>
                    <Form.Item name="birthday" rules={rules.bday}>
                        <CustomSelect
                            dropdownRender={(menu) => (
                                <div className="colored-dropdown">{menu}</div>
                            )}
                            placeholder={text.form.person.bday.placeholder}
                        >
                            {Array.from({ length: 59 }, (_, i) => i + 7).map(
                                (age) => (
                    ...
                    <Form.Item name="gender" rules={rules.gender}>
                        ...
                        >
                            <Select.Option value="male">
                                {text.form.person.gender.options[0]}
                            </Select.Option>
                            <Select.Option value="female">
                                {text.form.person.gender.options[1]}
                            </Select.Option>
                        </CustomSelect>
                    </Form.Item>
                </Col>
                    ...
                    <Form.Item name="height" rules={rules.height}>
                        ...
                        >
                            ...
                            {[...Array(89)].map((count, index) => (
                                <Select.Option key={index} value={index + 121}>
                                    {index + 121}cm
                                </Select.Option>
                            ))}
                ...
                <Col xs={24} md={8}>
                    <Form.Item name="weight" rules={rules.weight}>
                        ...
                        >
                            ...
                            {[...Array(89)].map((count, index) => (
                                <Select.Option key={index} value={index + 31}>
                                    {index + 31}kg
                                </Select.Option>
                            ))}
