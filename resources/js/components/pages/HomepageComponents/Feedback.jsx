            ...
            <CarouselContainer type='flex' justify='center' align='center' gutter={32}>
                ...
                <Col xs={24} md={12} style={{ position: "relative" }}>
                    ...
                    <ButtonContainer>
                        ...
                        <img className='last' src='/icon/next2.svg' alt="next" onClick={() => { ref.current.next() }} />
                    </ButtonContainer>
                    <Citation src='/icon/citation.svg' alt="" />
                    <Carousel ref={ref} showDots={false} removeArrowOnDeviceType={['mobile', 'desktop']} infinite responsive={responsive}>
                        {text.items.map((item) => (
                            <CarouselItem>
                                <p>
                                    {item.comment}
                    ...
                    <ViewMore>
                        <a target="_blank" href='https://www.google.com/search?channel=fs&q=be+local+madeira#lrd=0xc60619c49131751:0x9e71e279a1d4ccf2,1,,,'>
                            {text.viewmore}
                        </a>
                    </ViewMore>
                </Col>
