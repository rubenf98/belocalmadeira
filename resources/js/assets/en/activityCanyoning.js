export const text = {
    ...
    levels: {
        ...
        items: [
            ...
            { index: 1, visible: 1, price: "70€", title: "Beginner", subtitle: "Ribeira das Cales", paragraphs: ["This canyoning is intended for those who wish to have the first contact with the activity. It is a easy and accessible route for all ages (over 7 years old)."], from: 60, images: ["cales_01", "cales_02", "cales_03"] },
            { index: 2, visible: 1, price: "80€", title: "Intermediate", subtitle: "Nuns Valley (Summer Canyoning)", paragraphs: ["Surrounded by steep mountains, this canyon lies in the middle of the island, in the valley that the Nuns from Santa Clara convent fled to when Funchal was attacked by pirates in 1566."], from: 80, images: ["curral_01", "curral_02", "curral_03"] },
            { index: 2, visible: 1, price: "80€", title: "Intermediate", subtitle: "Ribeiro Frio (Winter Canyoning)", paragraphs: ["Canyoning Ribeiro Frio is a canyon in the north side of Madeira Island and consists in 8 rappels along the way. The Canyon is located within the Laurissilva Forest that is a UNESCO world heritage site since 1999 and one of the seven wonders of Portugal."], from: 80, images: ["ribeiro_frio_01", "ribeiro_frio_02", "ribeiro_frio_03"] },
            ...
            { index: 3, visible: 1, price: "150€", title: "Advanced", subtitle: "Ribeira Funda", paragraphs: ["Advanced Canyoning on Madeira Island distinguished by its great verticals and high technical level, offering epic endings by the north sea."], from: 150, images: ["funda_011", "funda_022", "funda_033"] },
        ],
        descriptions: [
