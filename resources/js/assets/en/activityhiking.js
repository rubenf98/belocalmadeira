...
export const text = {
    ...
    booking: {
        ...
        details: {
            ...
            items: {
                8: ["Moderate", "3km (6km round trip)", "2:30hrs", "Baía d'Abra / Casa do Sardinha", "126 m / 23 m", "Funchal, Pestana CR7 Hotel"],
                6: ["Moderate", "4.3km (8.6km round trip)", "3hrs", "Rabaçal (E.R. 105) / 25 Fontes", "1288 m / 964 m", "Funchal, Pestana CR7 Hotel"],
                7: ["Moderate", "6.1 km (VW) | 7km (VE)", "3:30hrs", "Pico do Areeiro Viewpoint / Pico Ruivo", "1857 m / 1491 m", "Funchal, Pestana CR7 Hotel"],
            },
        },
